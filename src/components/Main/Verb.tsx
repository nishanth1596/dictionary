...
function Verb({ data }: VerbProps) {
  ...
  return (
    <article className="mt-8 md:mt-10">
      ...
      <ul className="custom-bullets border-Gray-100 dark:border-Black-700 mx-4 mt-4 list-disc border-b-[1px] pb-8 text-[0.94rem] leading-6 font-normal md:ml-12 md:text-lg">
        <li className="text-Black-800 dark:text-White pl-2">{verb}</li>
